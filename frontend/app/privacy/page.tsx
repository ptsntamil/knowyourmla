  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
      <h1 className="text-4xl font-black tracking-tight text-text-primary mb-8 border-b border-border-subtle pb-4">
        Privacy <span className="text-text-accent">Policy</span>
      </h1>
      
      <div className="prose prose-invert max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">1. Data Collection</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">2. Analytics and Cookies</h2>
          <p className="text-text-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">3. External Links</h2>
          <p className="text-text-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">4. Updates to this Policy</h2>
          <p className="text-text-muted leading-relaxed">
