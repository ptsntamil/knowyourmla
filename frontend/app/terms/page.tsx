...
export default function TermsOfService() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
      <h1 className="text-4xl font-black tracking-tight text-text-primary mb-8 border-b border-border-subtle pb-4">
        Terms of <span className="text-text-accent">Service</span>
      </h1>
      
      <div className="prose prose-invert max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">1. Data Source & Accuracy</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">2. No Political Endorsement</h2>
          <p className="text-text-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">3. Permitted Usage</h2>
          <p className="text-text-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mb-4">4. Limitation of Liability</h2>
          <p className="text-text-muted leading-relaxed">
